...
class TestLoadSaveConfig:
    ...
    def test_save_and_load_projects_roundtrip(self, tmp_config):
        ...
        projects = [{"name": "p", "machine": "local", "path": "/tmp/p", "template": None}]
...
class TestGetProject:
    def test_get_project_found(self, tmp_config):
        ...
        save_projects([{"name": "foo", "machine": "local", "path": "/p", "template": None}])
...
class TestTemplateHooks:
    ...
    def test_remove_template_dir(self, tmp_config):
        from colette_cli.utils.config import ensure_template_dir, remove_template_dir, get_template_dir
...
class TestProjectHooks:
    ...
    def test_scaffold_project_hook_files(self, tmp_config):
        from colette_cli.utils.config import scaffold_project_hook_files, project_hook_exists
    ...
    def test_scaffold_project_hook_does_not_overwrite(self, tmp_config):
        from colette_cli.utils.config import scaffold_project_hook_files, write_project_hook, read_project_hook
